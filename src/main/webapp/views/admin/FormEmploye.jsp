        ...
        <div class="register-card">
            ...
            <form action="RegisterServlet" method="post" onsubmit="return validateForm()">
                <div class="row">
                    ...
                    <input type="hidden" name="typeCompte" value="employe" class="form-control" >
                    ...
                    <div class="col-md-6">
						...
						<div class="mb-4">
							...
							<div class="input-icon">
								<i class="fas fa-map-marked-alt"></i> <select
									class="form-control" id="idMunicipal" name="idMunicipal" required>
									<option value="">Sélectionnez un municipal</option>

									<c:forEach var="m" items="${sessionScope.muncipaux}">
						...
						<small class="text-muted">Région d'appartenance d'employé</small>
						</div>
